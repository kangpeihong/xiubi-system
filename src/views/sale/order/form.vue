<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" title="订单详情" width="70%">
    ...
    <div style="width:275px;float:left;margin-top:10px;margin-left:20px;20px;margin-bottom:10px;">客户名称:{{tableData.xwEnterprise.enterpriseName}}</div>
    ...
    <div class="basic" style="font-size: 16px;font-weight:bold;overflow:hidden;margin-top:20px;margin-bottom:10px">
      <span>订单内容</span>
    </div>

    <el-table :data="tableData.orderDetails" border show-summary style="width: 100%">
      <el-table-column prop="product.productName" label="产品名称" min-width="100px"></el-table-column>
      <el-table-column prop="price" label="产品单价(元)" min-width="100px"></el-table-column>
      <el-table-column prop="orderNumber" label="产品数量" min-width="100px"></el-table-column>
      <el-table-column prop="totalprice" sortable label="产品总价(元)" min-width="100px"></el-table-column>
    </el-table>

    <div slot="footer" class="dialog-footer">
      <el-button :loading="downloadLoading" size="mini" class="filter-item" type="warning" icon="el-icon-download" @click="download(tableData.id)">打印订单</el-button>
